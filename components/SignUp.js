...
import BedtimeSet from './BedtimeSet';
...
function SignUp(props) {
    ...
    async function nameCallback(name){
       SetName(name);
    }

    async function bedTimeCallback(bedTime,wakeTime){
        props.callback(bedTime,wakeTime)
    }

    return (
      <View style={styles.container}>
        {username==""?<NameSelect callback={nameCallback}/>:<BedtimeSet callback={bedTimeCallback}/>}
      </View>
    );
  }
